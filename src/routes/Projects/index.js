...
export default function Projects({
  ...
  const [posts, { title, content }, getPost] = useProjects(initialPost);

  const setPostId = id => history.push(`/projects/${id}`);
  ...
  const titleEl = (
    <Title>
      {postId && title ? (
        ...
        <span>Here you will see all the projects you will create, so basically, this will be your portfolio!</span>
      )}
    </Title>
  );
